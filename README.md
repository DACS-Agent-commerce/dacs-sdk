...
| `@kynesyslabs/dacs/rails` | no | x402 buyer settlement and seller paywall, evm-erc20 settlement, and optional AP2 admission/provider/replay plus provider adapters |
